...
export default function VerifyOtpForm() {
  ...
  useEffect(() => {
    if (
      ...
      // Start the countdown when the page loads if not already set
      if (countdown === null) {
        setCountdown(60);
      }
    }
  }, [email, resetToken, router, countdown, setCountdown, dispatch]);
